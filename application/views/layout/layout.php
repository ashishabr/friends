...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="logo-area">
                        <a href="#"><img src="<?= base_url(); ?>/assets/img/logo/friendslogo.png" width="50" alt="" /></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <?php $tag = $this->uri->segment(1); $tag2 = $this->uri->segment(2); ?>
    <div class="main-menu-area mg-tb-40">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        <li <?php if ($tag2 == NULL && $tag == 'dashboard') { ?> class="active" <?php } ?>  ><a href="<?= base_url('dashboard'); ?>"><i class="notika-icon notika-house"></i> Home</a>
                        </li>
                        <li <?php if ($tag2 == 'search') { ?> class="active" <?php } ?>><a href="<?= base_url('dashboard/search'); ?>"><i class="notika-icon notika-up-arrow"></i> Search friend</a>
                        </li>
                        <li <?php if ($tag2 == 'matches') { ?> class="active" <?php } ?>><a href="<?= base_url('dashboard/matches'); ?>"><i class="notika-icon notika-down-arrow"></i> Matches</a>
                        </li>
...
<?php $this->load->view($main_content); ?>
    ...
    <script src="<?= base_url(); ?>/assets/js/cs3.js"></script>
</body>
